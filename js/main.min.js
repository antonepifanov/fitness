...
/* harmony import */ var _modules_init_play_video__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/init-play-video */ "./js/modules/init-play-video.js");
/* harmony import */ var _modules_init_tabs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/init-tabs */ "./js/modules/init-tabs.js");
/* harmony import */ var _modules_init_coaches_slider__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/init-coaches-slider */ "./js/modules/init-coaches-slider.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    Object(_modules_init_play_video__WEBPACK_IMPORTED_MODULE_3__["initPlayVideo"])();
    ...
    Object(_modules_init_tabs__WEBPACK_IMPORTED_MODULE_4__["getSubscriptionsTabs"])();
    Object(_modules_init_coaches_slider__WEBPACK_IMPORTED_MODULE_5__["initCoachesSlider"])();
...
/*!*******************************************!*\
  !*** ./js/modules/init-coaches-slider.js ***!
  \*******************************************/
/*! exports provided: initCoachesSlider */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var initCoachesSlider = function initCoachesSlider() {
  var coachesSliderContainer = document.querySelector('.coaches__slider');
  if (!coachesSliderContainer) {
    return;
  }
  var coachSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](coachesSliderContainer, {
    ...
    on: {
      init: function init() {
        var slides = coachesSliderContainer.querySelectorAll('.swiper-slide');
        var doubleSlides = coachesSliderContainer.querySelectorAll('.swiper-slide-duplicate');
        var slidesLength = slides.length / 2;
        doubleSlides.forEach(function (slide) {
          slide.setAttribute('tabindex', '-1');
        });
        slides.forEach(function (slide) {
          slide.addEventListener('focus', function () {
            var index = slide.dataset.swiperSlideIndex;
            if (slidesLength - index >= 4) {
              coachSlider.slideToLoop("".concat(index), 300, true);
            }
          });
        });
      },
...
var initPlayVideo = function initPlayVideo() {
  var video = document.querySelector('.gyms__video video');
  if (!video) {
    return;
  }
  var playButton = document.querySelector('.gyms__video-play');
...
var initReviewsSlider = function initReviewsSlider() {
  ...
  var reviewsSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](reviewsSliderContainer, {
    modules: [swiper__WEBPACK_IMPORTED_MODULE_0__["Navigation"]],
    effect: 'slide',
    slidesPerView: 1,
    navigation: {
...
/*!*********************************!*\
  !*** ./js/modules/init-tabs.js ***!
  \*********************************/
/*! exports provided: getSubscriptionsTabs */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getSubscriptionsTabs", function() { return getSubscriptionsTabs; });
/* harmony import */ var _vendor_tabs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../vendor/tabs */ "./js/vendor/tabs.js");

var getSubscriptionsTabs = function getSubscriptionsTabs() {
  return new _vendor_tabs__WEBPACK_IMPORTED_MODULE_0__["Tabs"]('subscriptions', {
